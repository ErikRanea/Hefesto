<template>
    <div class="container-fluid h-100">
      <div class="row">
        <div class="col-md-6 h-100">
          <div class="d-flex flex-column h-100">
            <button class="glass-card mb-4" @click="openUsuariosPopup">
      ...
      <CRUDusuario ref="crudUsuarios" @close="closeUsuariosPopup" />
      <MaquinasPopup
  ...
  const crudUsuarios = ref(null);
  
  const openUsuariosPopup = () => {
    // Verifica si crudUsuarios.value está definido antes de llamar a openPopup
    if (crudUsuarios.value) {
      crudUsuarios.value.openPopup();
    } else {
      console.warn("crudUsuarios.value is null or undefined.");
    }
  };
  
  const closeUsuariosPopup = () => {
    // Lógica adicional si es necesario al cerrar el popup de usuarios
  };
